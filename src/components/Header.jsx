  ...
  return (
    ...
    <div id="headerWebComponent">
      ...
      <div className="header-nav-actions">
        ...
        <span>
          <img src="./src/assets/icons/akar-icons_search.svg" className="btn" />
        </span>
        <a href="">
          <img src="./src/assets/icons/akar-icons_heart.svg" className="btn" />
        </a>
        <a href="/cart">
          <img
    ...
    <div id="headerMobileComponent">
      ...
      <button className="btn d-md-none" id="menuToggle">
        <img src="./src/assets/icons/hamburger-menu.png" width={18} alt="Menu" />
